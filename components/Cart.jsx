      ...
      <div className='cart-container'>
        ...
        {cartItems.length < 1 && (
          <div className='empty-cart'>
            ...
            <Link href="/">
              <button type='button' onClick={()=> setshowCart(false)} className="btn">Contine Shopping</button>
            </Link>
          </div>
        )}
        ...
        {cartItems.length >= 1 &&(
          <div className='cart-bottom'>
            ...
            <div className='btn-container'>
              <Link href='/success'>
                <button type="button" className='btn' onClick={()=> setshowCart(false)}>Check Out</button>
              </Link>
